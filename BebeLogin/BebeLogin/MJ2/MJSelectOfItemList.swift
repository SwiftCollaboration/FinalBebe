...
class MJSelectOfItemListIsNull{
    ...
    var urlPath = "http://\(MJIPAddress.ipaddress)/bebeProject/bebegoods_buyList_select.jsp"
    
    func downloadItems(){
        print(MJLoginInfo.userEmail)
        ...
        for i in 0..<jsonResult.count{
            ...
            if let itemimage = jsonElement["itemimage"] as? String,
               ...
               let itemcode = jsonElement["itemcode"] as? String{
                ...
                let query = MJDBItemlist(itemimage: itemimage, itemtitle: itemtitle, usernickname: usernickname, address: address, useage: useage, itemcode: itemcode)
                locations.add(query)
            }
        }
...
class MJSelectOfItemListIsNotNull{
    ...
    var delegate:MJSelectOfItemListProtocol!
    var urlPath = "http://\(MJIPAddress.ipaddress)/bebeProject/bebegoods_buyList_end_select.jsp"
...
class MJSelectOfSellItemListIsNull{
    ...
    var delegate:MJSelectOfItemListProtocol!
    var urlPath = "http://\(MJIPAddress.ipaddress)/bebeProject/bebegoods_sellList_select.jsp"
...
class MJSelectOfSellItemListIsNotNull{
    ...
    var delegate:MJSelectOfItemListProtocol!
    var urlPath = "http://\(MJIPAddress.ipaddress)/bebeProject/bebegoods_sellList_end_select.jsp"
...
class MJSelectOfReviewItemListIsNotZero{
    ...
    var delegate:MJSelectOfItemListProtocol!
    var urlPath = "http://\(MJIPAddress.ipaddress)/bebeProject/bebegoods_reviewList_select.jsp"
...
class MJSelectOfReviewItemListIsZero{
    ...
    var delegate:MJSelectOfItemListProtocol!
    var urlPath = "http://\(MJIPAddress.ipaddress)/bebeProject/bebegoods_reviewList_end_select.jsp"
