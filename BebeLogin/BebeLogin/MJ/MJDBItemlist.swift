...
class MJDBItemlist: NSObject{
    var itemimage:String?, itemtitle:String?, usernickname:String?, address:String?, useage:String?, itemcode:String?, itemScore:String?
    
    // Empty constructor
    override init(){
        
    }
    init(itemimage:String, itemtitle:String, usernickname:String, address:String, useage:String, itemcode:String, itemScore:String) {
